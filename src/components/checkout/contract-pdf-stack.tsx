        ...
        <div className="relative z-10 mx-auto w-[92%] animate-contract-pdf-float">
          <div className="relative overflow-hidden rounded-xl border border-border bg-white shadow-2xl dark:bg-zinc-900 dark:shadow-black/40">
            ...
            <div className="pointer-events-none absolute inset-0 top-10 z-30 overflow-hidden">
              <div className="h-16 w-full bg-linear-to-b from-transparent via-blue-400/25 to-transparent dark:via-blue-300/20 animate-contract-pdf-scan" />
            </div>
            ...
            <div className="relative z-10 space-y-3 px-5 pb-6 pt-14 text-left text-xs leading-relaxed text-zinc-800 dark:text-zinc-200">
              <p className="font-mono text-[11px] text-blue-700 dark:text-blue-300">
                Mã hợp đồng: {orderCode}
              </p>
              <p>
                <span className="font-semibold">Bên A (Swiftera):</span> Cung
                cấp dịch vụ cho thuê thiết bị theo điều khoản đăng tải trên
                website.
              </p>
              <p>
                <span className="font-semibold">Bên B (Khách):</span>{" "}
                {customerName} - {customerPhone}
              </p>
              <p>
                <span className="font-semibold">
                  Tổng thanh toán (thuê + cọc):
                </span>{" "}
              ...
              <p className="text-muted-foreground">
                Tiền cọc hoàn trả trong 24h sau khi trả thiết bị đúng hiện
                trạng. Phí vận chuyển &amp; VAT (nếu có) tính theo hóa đơn
                riêng.
              </p>
              <div className="flex flex-wrap gap-6 border-t border-dashed border-border pt-4">
                ...
                <div>
                  ...
                  <p className="text-lg italic text-blue-600/80 dark:text-blue-400/90">
                    Swiftera ✓
                  </p>
                </div>
              </div>

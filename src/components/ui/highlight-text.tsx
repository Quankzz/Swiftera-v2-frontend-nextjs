...
const highlightVariants = cva("relative inline-block", {
  variants: {
    ...
    color: {
      primary:
        "[--highlight-color:oklch(0.65_0.2_160)] [&_path]:[stroke:var(--highlight-color)]",
      secondary:
        "[--highlight-color:oklch(0.55_0.15_270)] [&_path]:[stroke:var(--highlight-color)]",
      accent:
        "[--highlight-color:oklch(0.7_0.18_80)] [&_path]:[stroke:var(--highlight-color)]",
      destructive:
        "[--highlight-color:oklch(0.6_0.22_25)] [&_path]:[stroke:var(--highlight-color)]",
      teal: "[--highlight-color:#00b8d4] [&_path]:[stroke:var(--highlight-color)]",
    },
  },
  defaultVariants: {
    variant: "underline",

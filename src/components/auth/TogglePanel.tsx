      ...
      >
        ...
        >
          ...
          <Button
            ...
            variant="outline"
            onClick={onSignUp}
            className="h-auto border-white dark:border-theme-accent-end bg-transparent px-11 py-2.5 text-xs font-semibold uppercase tracking-wider text-white hover:bg-white/10 hover:text-white"
          >
            Đăng ký
          </Button>
        </div>

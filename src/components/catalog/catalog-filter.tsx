      ...
      {visible.map((opt) => (
        <label key={opt.id} className='flex cursor-pointer items-center gap-3'>
          <input
            ...
            className='size-5 rounded-sm border-gray-300 accent-theme-primary-start'
          />
            ...
            <div className='flex items-center gap-2'>
              <div className='relative flex-1'>
                <input
                  ...
                  placeholder='Từ'
                  className='h-11 w-full rounded-sm border border-gray-200 bg-white pl-3 pr-8 text-sm focus:border-theme-primary-start focus:outline-none focus:ring-2 focus:ring-theme-primary-start/20'
                />
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ...
                        : 'border-gray-200 bg-gray-50 text-text-sub hover:border-gray-300',
                    )}
                  >
                    {p.label}
                  </button>

...
export function getStaffOrders(staffUserId: string): Promise<RentalOrderResponse[]> {
  return fetchOrdersByStaffId(staffUserId);
}

/** Fetch a single order by ID. */
export async function getStaffOrderById(orderId: string): Promise<RentalOrderResponse | null> {

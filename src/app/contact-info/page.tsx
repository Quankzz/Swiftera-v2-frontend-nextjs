        ...
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-10">
          ...
          <section className="relative overflow-hidden rounded-3xl border border-border/60 bg-card px-6 py-8 shadow-sm sm:px-8 sm:py-10">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                Swiftera là nền tảng cho thuê thiết bị công nghệ hàng đầu tại Việt Nam.
                Chúng tôi luôn sẵn sàng hỗ trợ bạn qua các kênh liên lạc bên dưới.
              </p>
            </div>
          </section>
          ...
          <section className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md dark:bg-card/80">
              ...
              <h3 className="text-base font-bold text-foreground">Email CSKH</h3>
            ...
            <div className="group rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md dark:bg-card/80">
              ...
              <h3 className="text-base font-bold text-foreground">Email Sales</h3>
              <p className="mt-1 text-base font-semibold text-foreground group-hover:text-blue-500">
                sales@swiftera.vn
              </p>
              <p className="mt-1 text-xs text-muted-foreground">
            ...
            <div className="group rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md dark:bg-card/80">
              ...
              <h3 className="text-base font-bold text-foreground">Giờ hỗ trợ</h3>
              <div className="mt-3 space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Hotline & Ticket</span>
                  <span className="font-semibold text-foreground">08:00 – 21:00</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">CSKH Email</span>
                  <span className="font-semibold text-foreground">Trong giờ hành chính</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Ticket Online</span>
                  <span className="font-semibold text-foreground">24/7 tiếp nhận</span>
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md dark:bg-card/80">
              ...
              <h3 className="text-base font-bold text-foreground">Ticket hỗ trợ</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Gửi yêu cầu hỗ trợ trực tuyến qua hệ thống ticket trong tài khoản của bạn.
              </p>
              <Link
                href="/tickets"
                className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-500 transition-colors hover:text-blue-600"
            ...
            <div className="group rounded-2xl border border-border/60 bg-card p-6 shadow-sm transition-all hover:border-blue-500/30 hover:shadow-md dark:bg-card/80">
              ...
              <h3 className="text-base font-bold text-foreground">Phản hồi nhanh</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Gửi phản hồi hoặc góp ý về dịch vụ. Chúng tôi phản hồi trong thời gian sớm nhất.
              </p>
              <Link
                href="/feedback"
                className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-500 transition-colors hover:text-blue-600"

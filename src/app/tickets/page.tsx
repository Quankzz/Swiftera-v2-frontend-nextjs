...
import { useMyTickets, useTicketDetail } from '@/features/tickets/hooks/useTickets';
import {
          ...
          <div className='px-5 py-4 space-y-6'>
              ...
              <div className='space-y-2.5'>
                ...
                {t?.rentalOrderId && (
                  <div className='flex items-start gap-2.5'>
                    ...
                    <div>
                      <p className='text-xs text-gray-400'>Đơn thuê liên quan</p>
            ...
            {t?.sellerReply ? (
              ...
              <section className='p-4 rounded-xl border border-dashed border-gray-200 dark:border-white/8 text-center'>
                <RefreshCw size={16} className='mx-auto text-gray-300 dark:text-gray-600 mb-2' />
...
export default function MyTicketsPage() {
  const [statusFilter, setStatusFilter] = useState<ContactTicketStatus | 'ALL'>('ALL');
  const [page, setPage] = useState(0);
  const [selectedTicket, setSelectedTicket] = useState<ContactTicketResponse | null>(null);

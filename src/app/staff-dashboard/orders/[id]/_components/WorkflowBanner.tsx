...
export function WorkflowBanner({
  ...
  const wrapCls = {
    primary: 'border-theme-primary-start/20 bg-theme-primary-start/5 border-l-theme-primary-start',
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <h3 className={cn('text-lg font-bold mb-1 leading-tight', titleCls[variant])}>
          {title}
        </h3>

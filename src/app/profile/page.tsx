    ...
    <div className='relative'>
      ...
      <div className='relative z-10'>
        ...
        >
          ...
          <h1 className='text-4xl font-bold bg-linear-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-4'>
            Trang cá nhân
          </h1>
        ...
        >
          <div className='bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300'>
            ...
            <p className='text-sm text-gray-600'>Cập nhật tên và thông tin hiển thị</p>
          </div>
          ...
          <div className='bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300'>
            <div className='flex items-center space-x-3 mb-3'>
              ...
              <h3 className='font-semibold text-gray-900'>Cài đặt email</h3>
            </div>
            <p className='text-sm text-gray-600'>Thay đổi địa chỉ email liên kết</p>
          </div>
          ...
          <div className='bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300'>
            ...
            <p className='text-sm text-gray-600'>Đổi mật khẩu và bảo vệ tài khoản</p>
          </div>
        </motion.div>
        ...
        >
          <Suspense fallback={<div className='h-64 flex items-center justify-center text-gray-400 text-sm'>Đang tải...</div>}>
            <UserProfileClient />
          </Suspense>
        </motion.div>
      </div>

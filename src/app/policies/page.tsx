        ...
        <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-10">
                    ...
                    >
                      <div className="mb-3 flex flex-wrap items-center gap-2">
                        <Badge variant="secondary">
                          {getPolicyLabel(policy.code)}
                        </Badge>
                        <Badge variant="outline">
                          Phiên bản {policy.policyVersion}
                        </Badge>
                        {isHighlighted && (
          ...
          <div className="mt-5 rounded-2xl border border-border/60 bg-muted/25 p-4 text-sm text-muted-foreground">
            <p className="flex items-start gap-2">
              ...
              Mẹo: Bạn có thể xem nhanh PDF trực tiếp ngay trên trang để không
              bị ngắt luồng thao tác, hoặc mở tab mới nếu cần tải file về.
            </p>
          </div>
        </section>
      </div>
        ...
        <DialogContent className="max-h-[92dvh] overflow-y-auto p-5 sm:max-w-5xl">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {previewPolicy
                ? formatPolicyDate(previewPolicy.effectiveFrom)
                : "-"}
            </DialogDescription>
          </DialogHeader>

...
const EXTENDABLE_STATUSES: RentalOrderStatus[] = ["DELIVERED", "IN_USE"];
...
export default function RentalOrderDetailPage() {
  ...
  const requestCancellation = useRequestCancellation({
    onSuccess: () => {
      toast.success(
        "Yêu cầu hủy đơn đã được gửi. Bộ phận hỗ trợ sẽ xử lý trong thời gian sớm nhất.",
      );
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-cyan-700/80 dark:text-cyan-400/80">
                          Bộ phận hỗ trợ đang tiến hành thủ tục hoàn tiền cho
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-orange-700/80 dark:text-orange-400/80">
                          Nhân viên sẽ liên hệ và đến thu hồi thiết bị theo lịch
                          trình. Cảm ơn bạn đã sử dụng dịch vụ.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    ...
                    Bộ phận hỗ trợ sẽ tiến hành hoàn tiền cho bạn trong thời
                    gian sớm nhất.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-3">
                  ...
                  <div className="rounded-lg border border-amber-200/80 bg-amber-50/80 p-3 text-xs text-amber-800 dark:border-amber-800/50 dark:bg-amber-950/30 dark:text-amber-200">
                    Tiền cọc và tiền thuê sẽ được hoàn lại cho bạn trong thời
                    gian sớm nhất.
                  </div>
                </div>
                <DialogFooter>
            ...
            >
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Sau khi xác nhận, nhân viên sẽ liên hệ và sắp xếp lịch thu
                    hồi thiết bị theo địa chỉ giao hàng của bạn.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                  <Button
